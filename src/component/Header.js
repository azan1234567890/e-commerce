...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className='d-none d-sm-block header-upper second-header py-5'>
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2"><h2>
              <Link className='text-white third-header-link'>E-Commerce</Link>
            </h2>
            </div>
            <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                <div><Link className='third-header-link 'to="/Compare-Product" ><img className='header-2-mx' src="images/compare.svg" alt="" />Compare </Link></div>
                <div><Link className='third-header-link' to='/WishList'><img className='header-2-mx' src="images/wishlist.svg" alt="" />WishList</Link></div>
                <div><Link className='third-header-link' to="/Login" ><img className='header-2-mx' src="images/user.svg" alt="" />Login/SignUp</Link></div>
      ...
      <header className='d-none d-sm-block header-bottom py-3'>
        <div className="container-xxl">
          <div className="row">
              ...
              <div className='menu-bottom d-flex align-items-center gap-30'>
                ...
                <div className='menu-links'>
                  <div className="d-flex align-items-center gap-15">
                    ...
                    <NavLink className="third-header-link" to="/Blog">Blog</NavLink>
